...
def get_config():
    ...
    parser.add_argument("--checkpoint_path", default='../../../question_type_model', type=str,
                        help="The output directory where the model checkpoints and predictions will be written.")
    parser.add_argument("--model_name", type=str, default='BertForRelated',
                        help="The output directory where the model checkpoints and predictions will be written.")

    ## Other parameters
    parser.add_argument("--dev_file", default='../../../data/input.json', type=str,
                        help="dev file")
    ...
    #                     help="The output directory where the model checkpoints and predictions will be written.")
    parser.add_argument("--predict_result_path", default="../../../question_type_model/", type=str,
